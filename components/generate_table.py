...
def generate_table():
    ...
    with open(os.path.join(library_dir_path, 'README.md'), 'w') as f:
        ...
        table += "This library contains open dockerized components for ROS\n"
        table += "If you wish to use ROS2 check out our [ROS2 library](https://github.com/cogniteam/Library.Components.ROS2/tree/master)\n"
