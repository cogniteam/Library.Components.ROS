...
LynxSerialDriver::~LynxSerialDriver() {
	...
	if (serialPortPtr_) {
        //ROS_INFO("Closing and reseting the serial port");
        cout<<"Closing and reseting the serial port"<<endl;
...
void LynxSerialDriver::initializeSerial(const string& portName, int baudRate, bool reset) {
